...
func (this *BaseController) Prepare() {
	...
	this.Data["currentRoute"] = this.controllerName + "." + this.actionName
	this.Data["currentController"] = this.controllerName
	this.Data["currentAction"] = this.actionName
...
func (this *BaseController) auth() {
	...
	if this.userId == 0 && (this.controllerName != "main" ||
		(this.controllerName == "main" && this.actionName != "logout" && this.actionName != "login")) && this.controllerName != "install" {
