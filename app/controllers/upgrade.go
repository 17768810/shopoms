...
// 系统升级首页
func (this *UpgradeController) Index() {
...
// 个人信息
func (this *UpgradeController) Profile() {
...
// 登录
func (this *UpgradeController) Login() {
	if this.userId > 0 {
		this.redirect("/")
	}
	beego.ReadFromRequest(&this.Controller)
	if this.isPost() {
		...
		if username != "" && password != "" {
			...
			flash.Store(&this.Controller)
			this.redirect(beego.URLFor("UpgradeController.Login"))
		}
	}
...
// 退出登录
func (this *UpgradeController) Logout() {
	this.Ctx.SetCookie("auth", "")
	this.redirect(beego.URLFor("UpgradeController.Login"))
}

// 获取系统时间
func (this *UpgradeController) GetTime() {
